...
std::shared_ptr<SpeedController> RobotMap::shooterSubsystemintakeMotor;
...
void RobotMap::init() {
    ...
    shooterSubsystemintakeMotor.reset(new Talon(2));
    lw->AddActuator("ShooterSubsystem", "intakeMotor", std::static_pointer_cast<Talon>(shooterSubsystemintakeMotor));
